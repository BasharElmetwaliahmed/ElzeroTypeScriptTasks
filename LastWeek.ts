...
class RPG extends Game {
  constructor(override title: string,  public override price: numandstring, public rate: number) {
    super(title,price)
  }
...
class Action extends Game {
  constructor(title: string, public override price: numandstring, public rate: number,public company:string) {
        super(title,price)
...
function showTypes<F=string,S=string,T=string>(firstvalue:F|string='Nothing' ,secondvalue:S|string='Nothing',thirdvalue:T|string='Nothing'):string{
...
class Game <K>{
    constructor(public title:K,public price:number){}
    getDiscount(value:K):void{
